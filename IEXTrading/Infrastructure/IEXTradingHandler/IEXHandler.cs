        ...
        ****/
        public List<Company> GetSymbols()
        {
            ...
            if (!companyList.Equals(""))
            {
                ...
                tempnum = companies.Count;
            
                companies = companies.GetRange(0, 9);
            }
            return companies;
        }
        /*Method to get all symbols from IEX API */

        public List<Company> GetSymbolsTotal()
        {
            string IEXTrading_API_PATH = BASE_URL + "ref-data/symbols";
            string companyList = "";
        ...
        ****/
        ...
        public FinanceInfo GetFinancials(string symbol)
        {
            ...
            if (!financialDetails.Equals(""))
            {
                ...
                Result = JsonConvert.DeserializeObject<FinanceInfo>(financialDetails, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore });
